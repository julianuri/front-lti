  ...
  return ( <>
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={styles.field}>
        ...
        <div>
          <input
            ...
            className={(errors['rollsToShowQuestion'] != null) ? styles.isInvalidField + ' ' + styles.fullWidth : styles.fullWidth} {...register('rollsToShowQuestion', { required: true })}
          />
        </div>
      </div>
      <div className={styles.field}>
      ...
      {(<div className={styles.cardsContainer}>
        <Carousel selected={BOARDS[selectedCarouselItem]} handleClick={handleClick}/>
      </div>)}

      <input className={styles.button + ' ' + styles.atTheEnd} value='Create' type='submit' disabled={!isValid} />
    </form>
  </>);
};

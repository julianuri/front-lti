...
const GameSelector = () => {
    ...
    const gameSelector = <>
      ...
      <div className={classes.cardsContainer}>
        {games.map(x => {
          return <GameCard key={x.id} game={x} image={x.image_url} game_link={x.game_page}
    ...
    return (
      <>
        ...
        {(selectedGame.name == '') ? gameSelector :
          <button onClick={() => setSelectedGame({ name: '', id: 0 })}>Back</button>}
      </>
    );
  }
;

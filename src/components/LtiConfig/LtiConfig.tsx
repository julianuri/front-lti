...
const LtiConfig = () => {
  const deploymentRegex =
    /^\d:([a-zA-Z\d]){20,40}(?:[,;]\d:([a-zA-Z\d]){20,40}){0,9}$/;
          ...
          {tabs.map((tab) => {
            return (
              <li
                key={tab}
                id={tab}
                className={activeWindow === tab ? styles.active : undefined}
              >
                {tab}
              </li>
            );
        ...
        <>
            ...
            <>
              ...
              <form className={styles.form}>
                <div>
                  ...
                  <input
                    readOnly
                    {...register('redirect_uri', { required: true })}
                  />
                </div>
                <div>
                  ...
                  <input
                    readOnly
                    {...register('target_uri', { required: true })}
                  />
                </div>
                <div>
                  ...
                  <input
                    readOnly
                    {...register('openid_url', { required: true })}
                  />
                </div>
                <div className={styles.deployments}>
                  ...
                  <input
                    readOnly
                    {...register('public_jwk', { required: true })}
                  />
                </div>
                <input
                  value="Next"
          ...
          {activeWindow === 'Canvas' ? (
            <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
              ...
              {errors?.deployments != null ? (
                <div>{errors.deployments.message}</div>
              ) : null}

...
const AvatarBuilder = () => {
  ...
  const hairStyle = useRef([{ 'name': 'normal', 'avatarName': 'normal' },
    { 'name': 'long', 'avatarName': 'womanLong' }, { 'name': 'short', 'avatarName': 'womanShort' }]);
  ...
  const onSubmit = (data: any) => {
    ...
    saveAvatarConfig(data, userId).then(() => {
  ...
  return (
    <div className={styles.container}>
      <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        <Avatar style={{ width: '12rem', height: '12rem', 'gridColumn': '1/4' }} {...avatarEditor} />

        <div className={styles.field}>
          <label>Hair Style</label>
          <select {...register(AvatarParts.HAIR_STYLE, {
            onChange: (e) => {
              modifyAvatar(e.target.value, AvatarParts.HAIR_STYLE);
            }
          })}>
            {hairStyle.current.map((a: any) => {
              return <option key={a.name} value={a.avatarName}>{a.name}</option>;
            })}
          </select>
        </div>
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.EYEBROW_STYLE, {
            onChange: (e) => {
              modifyAvatar(e.target.value, AvatarParts.EYEBROW_STYLE);
            }
          })}>
            {[{'name':'normal', 'value': 'up' }, {'name': 'stylized', 'value':'upWoman'}].map((a: any) => {
              return <option key={a.name} value={a.value}>{a.name}</option>;
            })}
          </select>
        </div>
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.SHIRT_STYLE, {
            onChange: (e) => {
              modifyAvatar(e.target.value, AvatarParts.SHIRT_STYLE);
            }
          })}>
            {shirtStyles.current.map((a: any) => {
              return <option className={styles.option} key={a} value={a}>{a}</option>;
            })}
          </select>
        </div>
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.NOSE_STYLE, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.HAT_STYLE, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.GLASSES_STYLE, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <select id={AvatarParts.EYE_STYLE} {...register(AvatarParts.EYE_STYLE, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.EAR_SIZE, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <select {...register(AvatarParts.MOUTH_STYLE, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <input type='color' {...register(AvatarParts.HAT_COLOR, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <input type='color' {...register(AvatarParts.HAIR_COLOR, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <input type='color' {...register(AvatarParts.SHIRT_COLOR, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <input type='color' {...register(AvatarParts.FACE_COLOR, {
            onChange: (e) => {
        ...
        <div className={styles.field}>
          ...
          <input type='color' {...register(AvatarParts.BG_COLOR, {
            onChange: (e) => {
        ...
        <input className={styles.button + ' ' + styles.atTheEnd} value='Save Avatar' type='submit' />
      </form>
